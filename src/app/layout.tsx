  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      <head>
        ...
        <meta
          property="og:url"
          content="https://regret-archive.appwrite.network"
        />
        <meta
          property="og:title"
          content="Regret Archive - Share Your Regrets Anonymously"
        />
        <meta
          property="og:description"
          content="A safe, anonymous platform for sharing regrets and life lessons. Connect with others who understand your experiences."
        />
        <meta
          property="og:image"
          content="https://regret-archive.appwrite.network/og-image.png"
        />
      ...
      <body
        className={`${fredoka.variable} ${bungee.variable} bg-background text-foreground checker-background min-h-screen`}
      >
        <AuthProvider>
          <ProtectedRoute>
